...
<html>
    ...
    <body>
        ...
        <main class="container">
            <h1 style = "color:#212529; text-align: center; letter-spacing: 4px; margin-top: 20px">Spielregeln </h1>

            <hr style="border: #b51682 3px solid; border-radius: 10px; margin-top: 50px;">

            <h2> Die Schiffe dürfen </h2>
            ...
            <ul>
                ...
                <li>Sie können einen weiteren Spieler einladen indem sie auf Share link klicken und daraufhin 
                    den Link and die Person senden mit der Sie spielen möchten</li>
                <li>Platzieren sie die Schiffe indem sie diese mit der Maus auf die gewünschte 
                    Position auf dem Feld ziehen. Sie können sie auch drehen indem sie auf ein Schiff doppelklicken </li>
